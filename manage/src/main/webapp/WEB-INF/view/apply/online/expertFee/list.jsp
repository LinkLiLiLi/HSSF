...
<body>
<form action="apply/online/expertfee/list" method="post" id="searchForm">
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <shiro:hasPermission name="apply_expertfee_add">
        <li> <a class="button border-main icon-plus-square-o" href="javascript:void(0);" onclick="toadd()">创建专家费报销单</a> </li>
        </shiro:hasPermission>
        <li>搜索：</li>
        <li>
	...
	<script type="text/javascript">
		...
		function toadd(){
			window.location.href="apply/online/expertfee/toadd";
		}
		...
		function toedit(id){
			window.location.href = "apply/online/expertfee/toedit/"+id;
		}
		...
		function toprint(id){
			window.location.href = "apply/online/expertfee/toprint/"+id;
		}
