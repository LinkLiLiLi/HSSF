...
<body>
<form action="apply/online/remuneration/list" method="post" id="searchForm">
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <shiro:hasPermission name="apply_remuneration_add">
        <li> <a class="button border-main icon-plus-square-o" href="javascript:void(0);" onclick="toadd()">创建劳务计算单</a> </li>
        </shiro:hasPermission>
        <li>搜索：</li>
        <li>
      ...
      <td class="td-manage">
      	<div class="button-group">
      		<c:if test="${record.status == null || record.status == 2}">
	       		<shiro:hasPermission name="apply_remuneration_edit">
	       		<a class="button border-main" onclick="toedit('${record.id}')" href="javascript:;">
	       			<span class="icon-edit"></span> 编辑
	       		</a>
	       		</shiro:hasPermission>
	       		<shiro:hasPermission name="apply_remuneration_delete">
	...
	<script type="text/javascript">
		...
		function toadd(){
			window.location.href="apply/online/remuneration/toadd";
		}
		...
		function toedit(id){
			window.location.href = "apply/online/remuneration/toedit/"+id;
		}
		...
		function toprint(id){
			window.location.href = "apply/online/remuneration/toprint/"+id;
		}
