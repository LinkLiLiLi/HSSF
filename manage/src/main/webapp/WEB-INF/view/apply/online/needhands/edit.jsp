  ...
  <div class="body-content">
    <form action="apply/online/needhands/edit" method="post" class="form-x" id="form-article-add" >
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="dept" value="${needhands.dept}"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="applyDate" name="applyDate" value="${needhands.applyDate }"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field cc">
            <label><input name="employType" type="radio" <c:if test="${needhands.post == 1}">checked="checked" </c:if> class="ace" value="1"><span class="lbl">事业</span></label>&nbsp;&nbsp;
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="userName" value="${needhands.userName }"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="age" name="age" value="${needhands.age }"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="education" name="education" value="${needhands.education }" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="joinDate" name="joinDate" value="${needhands.joinDate }"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="termAmount" name="termAmount" value="${needhands.termAmount }" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="amount" name="amount" value="${needhands.amount }" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="trialAmount" name="trialAmount" value="${needhands.trialAmount }" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="trialAmountSubsidy" name="trialAmountSubsidy" value="${needhands.trialAmountSubsidy }" />
        </div>
      </div>
