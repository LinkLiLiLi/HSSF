...
<body>
<form action="apply/online/leave/0/list" method="post" id="searchForm">
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <shiro:hasPermission name="apply_leave0_add">
        <li> <a class="button border-main icon-plus-square-o" href="javascript:void(0);" onclick="toadd()">员工请假登记</a> </li>
        </shiro:hasPermission>
        <li>搜索：</li>
        <li>
          <input type="text" placeholder="请输入员工姓名" name="userName" class="input" style="width:200px; line-height:17px;display:inline-block;margin-left: 5px;"  value="${userName }" />
	...
	<script type="text/javascript">
		...
		function toadd(){
			window.location.href="apply/online/leave/0/toadd";
		}
		
		function toedit(id){
			window.location.href="apply/online/leave/0/toedit/"+ id;
		}
		...
		function toprint(id){
			window.location.href="apply/online/leave/0/toprint/"+ id;
		}
