  ...
  <div class="body-content">
    <form action="project/business/add" method="post" class="form-x" id="form-article-add" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="bussName" value=""/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="phoneNumber" value=""/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="salesman" value=""/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="contactDate" name="contactDate" value=""/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input"  name="bussContent" value=""/>
        </div>
      </div>
