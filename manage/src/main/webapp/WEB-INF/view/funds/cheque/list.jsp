...
<body>
<form action="funds/cheque/list" method="post" id="searchForm">
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
	     <shiro:hasPermission name="funds_cheque_add">
	        <li> <a class="button border-main icon-plus-square-o" href="javascript:void(0);" onclick="toadd()">支票登记</a> </li>
         </shiro:hasPermission>
        <li>搜索：</li>
        <li>
	...
	<script type="text/javascript">
		...
		function toadd(){
			window.location.href="funds/cheque/toadd";
		}
		...
		function toedit(id){
			window.location.href = "funds/cheque/toedit/"+id;
		}
		...
		function toprint(id){
			window.location.href = "funds/cheque/toprint/"+id;
		}
		function toaudit(id){
			window.location.href = "funds/cheque/toaudit/"+id;
		}
		function subaudit(id){
			if(confirm("确认提交审核？")){
				window.location.href = "funds/cheque/sub/"+id;
			}
		}
	</script>
</body>
